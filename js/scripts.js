...
let pokemonList = [ 
 ...
 // document.write() inside the loop’s code writes the Pokémon name on the website’s DOM.
 // string concatenation used to add the Pokémon’s height next to its name, for example, “Bulbasaur (height: 7)”.
 ...
 for (let i = 0; i < pokemonList.length; i++) {
   ...
   // get array objects
   let pokemonListObjects = pokemonList[i];
